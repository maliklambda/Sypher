...
pub fn parse_update<'a>(query: &mut Query) -> Result<UpdateQO, ParseQueryError> {
    println!("{query}");
...
fn parse_update_node<'a>(query: &mut Query) -> Result<UpdateNodeQO, ParseQueryError> {
    let id: NodeID = query
        .to_next_space()
...
fn parse_update_relationship<'a>(
    _query: &mut Query,
) -> Result<UpdateRelationshipQO, ParseQueryError> {
    todo!("parse update relationship");
}

fn parse_update_operations<'a>(query: &mut Query) -> Result<Vec<UpdateOperation>, ParseQueryError> {
...
fn parse_single_update_operation<'a>(
    query: &mut Query,
) -> Result<UpdateOperation, ParseQueryError> {
...
fn parse_update_operation_add<'a>(query: &mut Query) -> Result<UpdateOperation, ParseQueryError> {
    println!("{query}");
    let property = query
        .to_next_space()
...
fn parse_update_operation_set<'a>(query: &mut Query) -> Result<UpdateOperation, ParseQueryError> {
    let property = query
