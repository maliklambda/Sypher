...
use crate::parser::{
    errors::ParseQueryError, objects::QueryObject, query::Query, subqueries::tree::SubqueryIndexTree
};
...
impl QueryTree {
    pub fn from_raw_tree <'a>(_raw_tree: SubqueryIndexTree, _query: &Query) -> Result<Self, ParseQueryError<'a>> {
